package tech.vietinfo.zalo_login_plugin_vif;
...
/** ZaloLoginPluginVifPlugin */
public class ZaloLoginPluginVifPlugin implements FlutterPlugin, MethodCallHandler, ActivityAware {
  private static final String CHANNEL_NAME = "zalo_login_plugin";
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    ...
    _channel.setMethodCallHandler(new ZaloLoginPluginVifPlugin());
  }
